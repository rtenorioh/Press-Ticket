...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: "1.3.0",
      description:
        "Documentação da API para envio de mensagens e gerenciamento de contatos.",
      contact: {
    ...
    components: {
      securitySchemes: {
        apiToken: {
          ...
          in: "header",
          description:
            "Token de API para autenticação. Requer permissões específicas para cada rota."
        }
      }
    },
    tags: [
      ...
      {
        name: "Presence",
        description: "Indicadores de presença (digitando, gravando)"
      },
      ...
      {
        name: "Version",
        description: "Versão do sistema e biblioteca WhatsApp"
      },
