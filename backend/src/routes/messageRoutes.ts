...
messageRoutes.get(
  ...
  isAuth,
  MessageController.searchInTicket
);
messageRoutes.get(
  "/messages/:ticketId/starred",
  isAuth,
  MessageController.listStarred
);
...
messageRoutes.post(
  "/messages/:ticketId/contacts",
  isAuth,
  MessageController.sendContacts
);
messageRoutes.post(
...
messageRoutes.post(
  "/messages/:ticketId/presence/typing",
  isAuth,
  MessageController.sendTypingIndicator
);
messageRoutes.post(
  "/messages/:ticketId/presence/recording",
  isAuth,
  MessageController.sendRecordingIndicator
);
messageRoutes.post(
  "/messages/:ticketId/presence/available",
  isAuth,
