    ...
    id: {
        translations: {
            ...
            systemUpdate: {
                ...
                dialogTitle: "Konfigurasi Pembaruan",
                dialogDescription: "Pilih apa yang ingin Anda perbarui sebelum memulai proses.",
                dialogUpdateOS: "Perbarui Sistem Operasi",
                dialogUpdateOSDesc: "Menjalankan apt upgrade di server (disarankan).",
                dialogUpdateBrowser: "Perbarui Browser (Chromium)",
