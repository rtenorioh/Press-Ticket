    ...
    ja: {
        translations: {
            ...
            systemUpdate: {
                ...
                dialogTitle: "アップデートの設定",
                dialogDescription: "プロセスを開始する前に更新するものを選択してください。",
                dialogUpdateOS: "オペレーティングシステムの更新",
                dialogUpdateOSDesc: "サーバーで apt upgrade を実行します（推奨）。",
                dialogUpdateBrowser: "ブラウザの更新（Chromium）",
