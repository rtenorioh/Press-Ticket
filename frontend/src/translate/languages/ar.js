    ...
    ar: {
        translations: {
            ...
            systemUpdate: {
                ...
                dialogTitle: "تكوين التحديث",
                dialogDescription: "اختر ما تريد تحديثه قبل بدء العملية.",
                dialogUpdateOS: "تحديث نظام التشغيل",
                dialogUpdateOSDesc: "ينفذ apt upgrade على الخادم (موصى به).",
                dialogUpdateBrowser: "تحديث المتصفح (Chromium)",
