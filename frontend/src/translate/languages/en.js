  ...
  en: {
    translations: {
      ...
      systemUpdate: {
        ...
        dialogTitle: "Configure Update",
        dialogDescription: "Choose what you want to update before starting the process.",
        dialogUpdateOS: "Update Operating System",
        dialogUpdateOSDesc: "Runs apt upgrade on the server (recommended).",
        dialogUpdateBrowser: "Update Browser (Chromium)",
        dialogUpdateBrowserDesc: "Updates the Chromium used by WhatsApp Web JS.",
        dialogCancel: "Cancel",
        ...
        toastReconnecting: "♻️ System restarting... Reloading in {{seconds}}s",
        toastReloading: "✅ Reloading page...",
        statusUpdated: "System Updated",
        statusOutdated: "Update available: {{version}}",
        statusAhead: "Version ahead of repository",
