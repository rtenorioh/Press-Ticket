    ...
    hi: {
        translations: {
            ...
            systemUpdate: {
                ...
                dialogTitle: "अपडेट कॉन्फ़िगर करें",
                dialogDescription: "प्रक्रिया शुरू करने से पहले वह चुनें जो आप अपडेट करना चाहते हैं।",
                dialogUpdateOS: "ऑपरेटिंग सिस्टम अपडेट करें",
                dialogUpdateOSDesc: "सर्वर पर apt upgrade चलाता है (अनुशंसित)।",
                dialogUpdateBrowser: "ब्राउज़र अपडेट करें (Chromium)",
