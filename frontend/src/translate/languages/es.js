  ...
  es: {
    translations: {
      ...
      connections: {
        ...
        pairingCodeLabel: "Código de Vinculación",
        pairingCodeInstructions: "Abre WhatsApp en tu teléfono > Dispositivos vinculados > Vincular dispositivo > Introducir código",
        toolTips: {
          disconnected: {
      ...
      contactDrawer: {
        ...
        systemUpdate: {
          ...
          warningWindowsEnvironment: "La actualización automática solo está disponible en entornos Linux (VPS). Para actualizar localmente, ejecute: curl -sSL https://update.pressticket.com.br | sudo bash -s",
          updating: "Actualizando...",
          terminalRunning: "▋ ejecutando...",
          githubApiError: "No se pudo conectar a la API de GitHub. Verifique la conectividad del servidor. Para aumentar el límite de solicitudes, configure un GITHUB_TOKEN opcional en .env.",
          dialogTitle: "Configurar Actualización",
          dialogDescription: "Elija qué desea actualizar antes de iniciar el proceso.",
          dialogUpdateOS: "Actualizar Sistema Operativo",
          dialogUpdateOSDesc: "Ejecuta apt upgrade en el servidor (recomendado).",
          dialogUpdateBrowser: "Actualizar Navegador (Chromium)",
