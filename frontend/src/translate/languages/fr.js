    ...
    translations: {
      auth: {
        toasts: {
          ...
          session_expired: "Votre session a expiré parce qu'elle a été commencée sur un autre appareil."
        },
      },
      chat: {
      ...
      systemUpdate: {
        ...
        dialogTitle: "Configurer la mise à jour",
        dialogDescription: "Choisissez ce que vous souhaitez mettre à jour avant de démarrer le processus.",
        dialogUpdateOS: "Mettre à jour le système d'exploitation",
        dialogUpdateOSDesc: "Exécute apt upgrade sur le serveur (recommandé).",
        dialogUpdateBrowser: "Mettre à jour le navigateur (Chromium)",
        dialogUpdateBrowserDesc: "Met à jour le Chromium utilisé par WhatsApp Web JS.",
        dialogCancel: "Annuler",
        dialogConfirm: "Démarrer la mise à jour",
        dialogPasswordLabel: "Mot de passe du serveur (sudo)",
        dialogPasswordHelper: "Entrez le mot de passe de l'utilisateur qui exécute PM2 sur le serveur.",
      },
      backendErrors: {
