  ...
  pt: {
    translations: {
      ...
      messageOptionsMenu: {
        ...
        star: "Favoritar",
        unstar: "Desfavoritar",
        info: "Informações da mensagem",
        pinSuccess: "Mensagem fixada!",
        unpinSuccess: "Mensagem desfixada!",
        starSuccess: "Mensagem favoritada!",
        unstarSuccess: "Mensagem desfavoritada!",
        confirmationModal: {
      ...
      messageInfoModal: {
        ...
        reactions: "Reações",
        noReactions: "Sem reações",
        pollVotes: "Votos da enquete",
        noVotes: "Sem votos",
      },
      locationSendModal: {
      ...
      chatActions: {
        ...
        pin: "Fixar conversa",
        unpin: "Desfixar conversa",
        mute: "Silenciar",
        unmute: "Ativar notificações",
        markUnread: "Marcar como não lido",
        sendSeen: "Marcar como visto",
        clearMessages: "Limpar mensagens",
        archiveSuccess: "Chat arquivado!",
        unarchiveSuccess: "Chat desarquivado!",
        pinSuccess: "Chat fixado!",
        unpinSuccess: "Chat desfixado!",
        muteSuccess: "Chat silenciado!",
        unmuteSuccess: "Notificações ativadas!",
        markUnreadSuccess: "Marcado como não lido!",
        sendSeenSuccess: "Marcado como visto!",
        clearSuccess: "Mensagens limpas!",
        clearConfirm: "Tem certeza que deseja limpar todas as mensagens?",
        pinned: "Fixada",
        muted: "Silenciada",
        archived: "Arquivada",
        pinnedIndicator: "Esta conversa está fixada no WhatsApp",
        mutedIndicator: "Esta conversa está silenciada no WhatsApp",
        archivedIndicator: "Esta conversa está arquivada no WhatsApp",
      },
      ticketListMenu: {
        pin: "Fixar ticket",
        unpin: "Desfixar ticket",
        mute: "Silenciar ticket",
        unmute: "Ativar notificações",
        favorite: "Adicionar aos favoritos",
        unfavorite: "Remover dos favoritos",
        pinLimitReached: "Limite de 3 tickets fixados atingido",
        favoritedIndicator: "Este ticket está nos favoritos",
      },
      ticketLabelsFilter: {
        all: "Tudo",
        favorited: "Favoritos",
        unread: "Não lidas",
        groups: "Grupos",
        noLabels: "Nenhuma etiqueta encontrada",
      },
      labelsPanel: {
        title: "Etiquetas",
        ...
        updated: "Etiquetas atualizadas!",
      },
      contactActions: {
        about: "Sobre",
        block: "Bloquear",
        unblock: "Desbloquear",
        commonGroups: "Grupos em comum",
        noCommonGroups: "Nenhum grupo em comum",
        blockConfirm: "Deseja bloquear este contato?",
        blockSuccess: "Contato bloqueado!",
        unblockSuccess: "Contato desbloqueado!",
      ...
      profileSettings: {
        ...
        pictureSuccess: "Foto atualizada!",
        pictureRemoved: "Foto removida!",
        wwebVersion: "Versão do WhatsApp Web",
        presence: "Presença",
      ...
      queueModal: {
        ...
        form: {
          ...
          n8nUrlHelper: "Informe a URL do webhook do n8n para este setor",
        },
        buttons: {
          okAdd: "Adicionar",
          okEdit: "Salvar",
      ...
      queues: {
        ...
        table: {
          ...
          workHours: "Horários",
          n8n: "n8n",
          n8nDisabled: "n8n desativado",
          n8nEnabledNoUrl: "n8n ativo (sem URL configurada)",
          actions: "Ações",
          startWork: "Abertura",
          endWork: "Fechamento",
          edit: "Editar",
      ...
      systemUpdate: {
        ...
        dialogTitle: "Configurar Atualização",
        dialogDescription: "Escolha o que deseja atualizar antes de iniciar o processo.",
        dialogUpdateOS: "Atualizar Sistema Operacional",
        dialogUpdateOSDesc: "Executa apt upgrade no servidor (recomendado).",
        dialogUpdateBrowser: "Atualizar Navegador (Chromium)",
