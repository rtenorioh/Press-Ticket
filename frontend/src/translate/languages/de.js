    ...
    translations: {
      auth: {
        toasts: {
          ...
          session_expired: "Ihre Sitzung ist abgelaufen, da sie auf einem anderen Gerät gestartet wurde."
      ...
      tickets: {
        ...
        confirmationModal: {
          closeTicket: {
              ...
              message: "Sind Sie sicher, dass Sie dieses Ticket schließen möchten?",
          },
        },
      },
      transferTicketModal: {
      ...
      systemUpdate: {
        ...
        warningWindowsEnvironment: "Das automatische Update ist nur in Linux-Umgebungen (VPS) verfügbar. Führen Sie zum lokalen Aktualisieren aus: curl -sSL https://update.pressticket.com.br | sudo bash -s",
        updating: "Aktualisierung läuft...",
        terminalRunning: "▋ läuft...",
        githubApiError: "Verbindung zur GitHub-API fehlgeschlagen. Überprüfen Sie die Serverkonnektivität. Um das Anfragelimit zu erhöhen, konfigurieren Sie optional einen GITHUB_TOKEN in .env.",
        dialogTitle: "Update konfigurieren",
        dialogDescription: "Wählen Sie, was Sie vor dem Start des Prozesses aktualisieren möchten.",
        dialogUpdateOS: "Betriebssystem aktualisieren",
        dialogUpdateOSDesc: "Führt apt upgrade auf dem Server aus (empfohlen).",
        dialogUpdateBrowser: "Browser aktualisieren (Chromium)",
        dialogUpdateBrowserDesc: "Aktualisiert das Chromium, das von WhatsApp Web JS verwendet wird.",
        dialogCancel: "Abbrechen",
        dialogConfirm: "Update starten",
        dialogPasswordLabel: "Server-Passwort (sudo)",
        dialogPasswordHelper: "Geben Sie das Passwort des Benutzers ein, der PM2 auf dem Server ausführt.",
      },
      backendErrors: {
