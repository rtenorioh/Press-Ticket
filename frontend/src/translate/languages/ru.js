    ...
    ru: {
        translations: {
            ...
            systemUpdate: {
                ...
                dialogTitle: "Настройка обновления",
                dialogDescription: "Выберите, что хотите обновить перед запуском процесса.",
                dialogUpdateOS: "Обновить операционную систему",
                dialogUpdateOSDesc: "Выполняет apt upgrade на сервере (рекомендуется).",
                dialogUpdateBrowser: "Обновить браузер (Chromium)",
                dialogUpdateBrowserDesc: "Обновляет Chromium, используемый WhatsApp Web JS.",
                dialogCancel: "Отмена",
                dialogConfirm: "Начать обновление",
                dialogPasswordLabel: "Пароль сервера (sudo)",
                dialogPasswordHelper: "Введите пароль пользователя, запускающего PM2 на сервере.",
            },
            backendErrors: {
