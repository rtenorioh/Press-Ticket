    ...
    it: {
        translations: {
            ...
            systemUpdate: {
                ...
                dialogTitle: "Configura Aggiornamento",
                dialogDescription: "Scegli cosa vuoi aggiornare prima di avviare il processo.",
                dialogUpdateOS: "Aggiorna Sistema Operativo",
                dialogUpdateOSDesc: "Esegue apt upgrade sul server (consigliato).",
                dialogUpdateBrowser: "Aggiorna Browser (Chromium)",
